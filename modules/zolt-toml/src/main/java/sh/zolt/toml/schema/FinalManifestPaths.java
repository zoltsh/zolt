...
public final class FinalManifestPaths {
    ...
    static final ManifestPath DEPENDENCIES_PROVIDED = DEPENDENCIES.child("provided");
    static final ManifestPath DEPENDENCIES_DEV = DEPENDENCIES.child("dev");
    static final ManifestPath DEPENDENCIES_TEST = DEPENDENCIES.child("test");
    static final ManifestPath DEPENDENCIES_PROCESSOR = DEPENDENCIES.child("processor");
    static final ManifestPath DEPENDENCIES_TEST_PROCESSOR = DEPENDENCIES.child("test-processor");
    static final ManifestPath DEPENDENCY_CONSTRAINTS = DEPENDENCIES.child("constraints");
    static final ManifestPath DEPENDENCY_POLICY = DEPENDENCIES.child("policy");
    static final ManifestPath DEPENDENCY_LICENSE_POLICY = DEPENDENCY_POLICY.child("licenses");
    static final ManifestPath DEPENDENCY_LICENSE_EXCEPTIONS = DEPENDENCIES.child("license-exceptions");
    static final ManifestPath DEPENDENCY_LICENSE_EXCEPTION =
