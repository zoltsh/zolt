 ...
 * The effective compiler identity is also present in the no-op fingerprint and incremental state so
 * every reuse layer makes the same decision. A shared cache additionally folds it into its outer key.
 */
