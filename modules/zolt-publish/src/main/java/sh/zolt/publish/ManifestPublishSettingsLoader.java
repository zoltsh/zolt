 ...
 *
 * <p>Publication settings are project-local (design §4.5), so the authored document is read without
 * workspace composition; that also lets a sparse workspace member manifest be a valid input.
 * Credential references are validated during effective composition (design §14.2), not here.
 */
