...
import sh.zolt.manifest.AuthoredBom;
import sh.zolt.manifest.AuthoredBuildConfiguration;
import sh.zolt.manifest.AuthoredDependencyRepositories;
import sh.zolt.manifest.AuthoredManifest;
import sh.zolt.manifest.AuthoredPackaging;
import sh.zolt.manifest.AuthoredProjectMetadata;
import sh.zolt.manifest.AuthoredToolchains;
import sh.zolt.manifest.AuthoredWorkspace;
import sh.zolt.manifest.AuthoredWorkspaceMembers;
